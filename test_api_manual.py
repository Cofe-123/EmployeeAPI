...
# ── 2. Register ──────────────────────────────────
status, data = req(
    "POST", "/auth/register", {"username": "demo_admin", "password": "Demo@123"}
)
pp("2. POST /auth/register", status, data)

# ── 3. Login ─────────────────────────────────────
status, data = req(
    "POST", "/auth/login", {"username": "demo_admin", "password": "Demo@123"}
)
...
status, data = req(
    ...
    {"course": "Data Science", "last_name": "Smith-Updated"},
    token=TOKEN,
)
